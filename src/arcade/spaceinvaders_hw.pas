...
const
        ...
        spaceinv_samples:array[0..9] of tipo_nombre_samples=(
...
if event.arcade then begin
  ...
  if arcade_input.left[0] then marcade.in0:=marcade.in0 or $20;
  if arcade_input.right[0] then marcade.in0:=marcade.in0 or $40;
  //System
