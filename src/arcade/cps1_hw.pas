...
const
        ...
        ghouls_gfx2:array[0..16] of tipo_roms=(
        ...
        ffight_oki:array[0..2] of tipo_roms=(
        ...
        kod_oki:array[0..2] of tipo_roms=(
        ...
        sf2_oki:array[0..2] of tipo_roms=(
        ...
        strider_oki:array[0..2] of tipo_roms=(
        ...
        wonder3_oki:array[0..2] of tipo_roms=(
        ...
        ccommando_oki:array[0..2] of tipo_roms=(
        ...
        knights_oki:array[0..2] of tipo_roms=(
        ...
        sf2ce_oki:array[0..2] of tipo_roms=(
        ...
        dino_qsound1:array[0..4] of tipo_roms=(
        ...
        punisher_qsound1:array[0..4] of tipo_roms=(
        ...
        willow_oki:array[0..2] of tipo_roms=(
        ...
        ca1941_oki:array[0..2] of tipo_roms=(
        ...
        nemo_oki:array[0..2] of tipo_roms=(
        (n:'nme_18.11c';l:$20000;p:0;crc:$bab333d4),(n:'nme_19.12c';l:$20000;p:$20000;crc:$2650a0a8),());

implementation
uses nz80,m68000,main_engine,controls_engine,gfx_engine,timer_engine,ym_2151,
     oki6295,kabuki_decript,qsound,misc_functions,pal_engine,sound_engine,eepromser;
...
if event.arcade then begin
  ...
  if arcade_input.but2[1] then marcade.in1:=marcade.in1 and $bfff;
  //Extra buttons
  if arcade_input.but3[0] then marcade.in2:=marcade.in2 and $fffe;
  if arcade_input.but4[0] then marcade.in2:=marcade.in2 and $fffd;
  if arcade_input.but5[0] then marcade.in2:=marcade.in2 and $fffb;
  if arcade_input.but3[1] then marcade.in2:=marcade.in2 and $ffef;
  if arcade_input.but4[1] then marcade.in2:=marcade.in2 and $ffdf;
  if arcade_input.but5[1] then marcade.in2:=marcade.in2 and $ffbf;
  //SYS
  if arcade_input.coin[0] then marcade.in0:=marcade.in0 and $feff;
  if arcade_input.coin[1] then marcade.in0:=marcade.in0 and $fdff;
  if arcade_input.start[0] then marcade.in0:=marcade.in0 and $efff;
  if arcade_input.start[1] then marcade.in0:=marcade.in0 and $dfff;
end;
end;
