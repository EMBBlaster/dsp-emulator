...
interface
uses sysutils,main_engine,rom_engine,lenguaje,controls_engine,
  samples,
  //Computer
  spectrum_48k,spectrum_128k,spectrum_3,amstrad_cpc,commodore64,spectrum_misc,
  //Console
  ...
  system1_hw_misc,system2_hw_misc,rallyx_hw,pooyan_hw,cityconnection_hw,
  burgertime_hw,expressraider_hw,superbasketball_hw,ladybug_hw,
  tehkanworldcup_hw,popeye_hw,psychic5_hw,terracresta_hw,m62_hw,shootout_hw,
  vigilante_hw,jackal_hw,bubblebobble_hw,galaxian_hw,prehistoricisle_hw,
  tigerroad_hw,snowbros_hw,toki_hw,contra_hw,mappy_hw,rastan_hw,
  legendarywings_hw,streetfighter_hw,galaga_hw,namcoio_06xx_5Xxx,
  xaindsleena_hw,suna8_hw,nmk16_hw,knucklejoe_hw,wardner_hw,gaelco_hw,
  exedexes_hw,gunsmoke_hw,hw_1942,jailbreak_hw,circuscharlie_hw,ironhorse_hw,
  m72_hw,breakthru_hw,
...
type
  tgame_desc=record
              ...
              grid:word;
              company:string;
              rom:array of ptipo_roms;
              samples:array of ptipo_nombre_samples;
              tipo:word;
            end;
...
const
  ...
  //Computers
  (name:'Spectrum 48K';year:'1982';snd:1;hi:false;zip:'spectrum';grid:0;company:'Sinclair';rom:[@spectrum_rom,nil];tipo:COMPUTER),
  (name:'Spectrum 128K';year:'1986';snd:1;hi:false;zip:'spec128';grid:1;company:'Sinclair';rom:[@spec128_rom,nil];tipo:COMPUTER),
  (name:'Spectrum +3';year:'1987';snd:1;hi:false;zip:'plus3';grid:2;company:'Amstrad';rom:[@plus3_rom,nil];tipo:COMPUTER),
  (name:'Spectrum +2A';year:'1987';snd:1;hi:false;zip:'plus3';grid:3;company:'Amstrad';rom:[@plus3_rom,nil];tipo:COMPUTER),
  (name:'Spectrum +2';year:'1986';snd:1;hi:false;zip:'plus2';grid:4;company:'Amstrad';rom:[@spec_plus2_rom,nil];tipo:COMPUTER),
  (name:'Spectrum 16K';year:'1982';snd:1;hi:false;zip:'spectrum';grid:5;company:'Sinclair';rom:[@spectrum_rom,nil];tipo:COMPUTER),
  (name:'Amstrad CPC 464';year:'1984';snd:1;hi:false;zip:'cpc464';grid:7;company:'Amstrad';rom:[@cpc464_rom,nil];tipo:COMPUTER),
  (name:'Amstrad CPC 664';year:'1984';snd:1;hi:false;zip:'cpc664';grid:8;company:'Amstrad';rom:[@cpc664_rom,@ams_rom,nil];tipo:COMPUTER),
  (name:'Amstrad CPC 6128';year:'1985';snd:1;hi:false;zip:'cpc6128';grid:9;company:'Amstrad';rom:[@cpc6128_rom,@ams_rom,nil];tipo:COMPUTER),
  (name:'Commodore 64';year:'1982';snd:1;hi:false;zip:'c64';grid:3000;company:'Commodore';rom:[@c64_kernel,@c64_basic,@c64_char,nil];tipo:COMPUTER),
  (name:'Oric Atmos';year:'1984';snd:1;hi:false;zip:'orica';grid:3001;company:'Tangerine';rom:[@atmos_rom,nil];tipo:COMPUTER),
  (name:'Oric 1';year:'1983';snd:1;hi:false;zip:'oric1';grid:3002;company:'Tangerine';rom:[@oric1_rom,nil];tipo:COMPUTER),
  (name:'MSX - Sanyo MPC-100';year:'1980';snd:1;hi:false;zip:'mpc100';grid:3003;company:'Sanyo';rom:[@mpc100_bios,nil];tipo:COMPUTER),
  //Arcade
  (name:'Pacman';year:'1980';snd:1;hi:false;zip:'pacman';grid:10;company:'Namco';rom:[@pacman_rom,@pacman_sound,@pacman_pal,nil];tipo:ARCADE or MAZE),
  (name:'Phoenix';year:'1980';snd:1;hi:false;zip:'phoenix';grid:11;company:'Amstar Electronics';rom:[@phoenix_rom,nil];tipo:ARCADE or SHOT),
  (name:'Mysterious Stones';year:'1984';snd:1;hi:false;zip:'mystston';grid:12;company:'Technos';rom:[@mstone_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Bomb Jack';year:'1984';snd:1;hi:false;zip:'bombjack';grid:13;company:'Tehkan';rom:[@bombjack_rom,nil];tipo:ARCADE or MAZE),
  (name:'Frogger';year:'1981';snd:1;hi:true;zip:'frogger';grid:14;company:'Konami';rom:[@frogger_rom,nil];tipo:ARCADE or MAZE),
  (name:'Donkey Kong';year:'1981';snd:2;hi:false;zip:'dkong';grid:15;company:'Nintendo';rom:[@dkong_rom,nil];samples:[@dkong_samples,nil];tipo:ARCADE or MAZE),
  (name:'Black Tiger';year:'1986';snd:1;hi:true;zip:'blktiger';grid:16;company:'Capcom';rom:[@blktiger_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Green Beret';year:'1985';snd:1;hi:true;zip:'gberet';grid:17;company:'Konami';rom:[@gberet_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Commando';year:'1985';snd:1;hi:false;zip:'commando';grid:18;company:'Capcom';rom:[@commando_rom,nil];tipo:ARCADE or RUN_GUN or SHOT),
  (name:'Ghosts''n Goblins';year:'1985';snd:1;hi:false;zip:'gng';grid:19;company:'Capcom';rom:[@gng_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Mikie';year:'1985';snd:1;hi:false;zip:'mikie';grid:20;company:'Konami';rom:[@mikie_rom,nil];tipo:ARCADE or MAZE),
  (name:'Shaolin''s Road';year:'1985';snd:1;hi:false;zip:'shaolins';grid:21;company:'Konami';rom:[@shaolin_rom,nil];tipo:ARCADE or MAZE),
  (name:'Yie Ar Kung-Fu';year:'1985';snd:1;hi:false;zip:'yiear';grid:22;company:'Konami';rom:[@yiear_rom,nil];tipo:ARCADE or FIGHT),
  (name:'Asteroids';year:'1979';snd:2;hi:false;zip:'asteroid';grid:23;company:'Atari';rom:[@as_rom,nil];samples:[@asteroids_samples,nil];tipo:ARCADE or SHOT),
  (name:'Son Son';year:'1984';snd:1;hi:false;zip:'sonson';grid:24;company:'Capcom';rom:[@sonson_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Star Force';year:'1984';snd:1;hi:false;zip:'starforc';grid:25;company:'Tehkan';rom:[@starforce_rom,nil];tipo:ARCADE or SHOT),
  (name:'Rygar';year:'1986';snd:1;hi:false;zip:'rygar';grid:26;company:'Tecmo';rom:[@rygar_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Pitfall II';year:'1984';snd:1;hi:false;zip:'pitfall2';grid:27;company:'Sega';rom:[@pitfall2_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Pooyan';year:'1982';snd:1;hi:false;zip:'pooyan';grid:28;company:'Konami';rom:[@pooyan_rom,nil];tipo:ARCADE or SHOT),
  (name:'Jungler';year:'1981';snd:1;hi:false;zip:'jungler';grid:29;company:'Konami';rom:[@jungler_rom,nil];tipo:ARCADE or MAZE),
  (name:'City Connection';year:'1986';snd:1;hi:false;zip:'citycon';grid:30;company:'Jaleco';rom:[@citycon_rom,nil];tipo:ARCADE or DRIVE),
  (name:'Burger Time';year:'1982';snd:1;hi:false;zip:'btime';grid:31;company:'Deco';rom:[@btime_rom,nil];tipo:ARCADE or MAZE),
  (name:'Express Raider';year:'1986';snd:1;hi:false;zip:'exprraid';grid:32;company:'Deco';rom:[@expraid_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Super Basketball';year:'1984';snd:1;hi:false;zip:'sbasketb';grid:33;company:'Konami';rom:[@sbasketb_rom,nil];tipo:ARCADE or SPORT),
  (name:'Lady Bug';year:'1981';snd:1;hi:false;zip:'ladybug';grid:34;company:'Universal';rom:[@ladybug_rom,nil];tipo:ARCADE or MAZE),
  (name:'Teddy Boy Blues';year:'1985';snd:1;hi:false;zip:'teddybb';grid:35;company:'Sega';rom:[@teddy_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Wonder Boy';year:'1986';snd:1;hi:false;zip:'wboy';grid:36;company:'Sega';rom:[@wboy_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Wonder Boy in Monster Land';year:'1987';snd:1;hi:false;zip:'wbml';grid:37;company:'Sega';rom:[@wbml_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Tehkan World Cup';year:'1985';snd:1;hi:false;zip:'tehkanwc';grid:38;company:'Tehkan';rom:[@tehkanwc_rom,nil];tipo:ARCADE or SPORT),
  (name:'Popeye';year:'1982';snd:1;hi:false;zip:'popeye';grid:39;company:'Nintendo';rom:[@popeye_rom,nil];tipo:ARCADE or MAZE),
  (name:'Psychic 5';year:'1987';snd:1;hi:false;zip:'psychic5';grid:40;company:'Jaleco';rom:[@psychic5_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Terra Cresta';year:'1985';snd:1;hi:false;zip:'terracre';grid:41;company:'Nichibutsu';rom:[@terracre_rom,nil];tipo:ARCADE or SHOT),
  (name:'Kung-Fu Master';year:'1987';snd:1;hi:false;zip:'kungfum';grid:42;company:'Irem';rom:[@kungfum_rom,nil];tipo:ARCADE or FIGHT),
  (name:'Shoot Out';year:'1985';snd:1;hi:false;zip:'shootout';grid:43;company:'Data East';rom:[@shootout_rom,nil];tipo:ARCADE or SHOT),
  (name:'Vigilante';year:'1988';snd:1;hi:false;zip:'vigilant';grid:44;company:'Irem';rom:[@vigilante_rom,nil];tipo:ARCADE or FIGHT),
  (name:'Jackal';year:'1986';snd:1;hi:false;zip:'jackal';grid:45;company:'Konami';rom:[@jackal_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Bubble Bobble';year:'1986';snd:1;hi:false;zip:'bublbobl';grid:46;company:'Taito';rom:[@bublbobl_rom,nil];tipo:ARCADE or MAZE),
  (name:'Galaxian';year:'1979';snd:4;hi:false;zip:'galaxian';grid:47;company:'Namco';rom:[@galaxian_rom,nil];samples:[@galaxian_samples,nil];tipo:ARCADE or SHOT),
  (name:'Jump Bug';year:'1981';snd:1;hi:false;zip:'jumpbug';grid:48;company:'Rock-Ola';rom:[@jumpbug_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Moon Cresta';year:'1980';snd:4;hi:false;zip:'mooncrst';grid:49;company:'Nichibutsu';rom:[@mooncrst_rom,nil];samples:[@mooncrst_samples,nil];tipo:ARCADE or SHOT),
  (name:'Rally X';year:'1980';snd:3;hi:false;zip:'rallyx';grid:50;company:'Namco';rom:[@rallyx_rom,nil];samples:[@rallyx_samples,nil];tipo:ARCADE or DRIVE or MAZE),
  (name:'Prehistoric Isle in 1930';year:'1989';snd:1;hi:false;zip:'prehisle';grid:51;company:'SNK';rom:[@prehisle_rom,nil];tipo:ARCADE or SHOT),
  (name:'Tiger Road';year:'1987';snd:1;hi:false;zip:'tigeroad';grid:52;company:'Capcom';rom:[@tigeroad_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'F1 Dream';year:'1988';snd:1;hi:false;zip:'f1dream';grid:53;company:'Capcom';rom:[@f1dream_rom,nil];tipo:ARCADE or SPORT or DRIVE),
  (name:'Snowbros';year:'1990';snd:1;hi:false;zip:'snowbros';grid:54;company:'Toaplan';rom:[@snowbros_rom,nil];tipo:ARCADE or MAZE),
  (name:'Toki';year:'1989';snd:1;hi:false;zip:'toki';grid:55;company:'TAD';rom:[@toki_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Contra';year:'1987';snd:1;hi:false;zip:'contra';grid:56;company:'Konami';rom:[@contra_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Mappy';year:'1983';snd:1;hi:false;zip:'mappy';grid:57;company:'Namco';rom:[@mappy_rom,nil];tipo:ARCADE or MAZE),
  (name:'Rastan';year:'1987';snd:1;hi:false;zip:'rastan';grid:58;company:'Taito';rom:[@rastan_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Legendary Wings';year:'1986';snd:1;hi:false;zip:'lwings';grid:59;company:'Capcom';rom:[@lwings_rom,nil];tipo:ARCADE or RUN_GUN or SHOT),
  (name:'Section Z';year:'1985';snd:1;hi:false;zip:'sectionz';grid:60;company:'Capcom';rom:[@sectionz_rom,nil];tipo:ARCADE or RUN_GUN or SHOT),
  (name:'Trojan';year:'1986';snd:1;hi:false;zip:'trojan';grid:61;company:'Capcom';rom:[@trojan_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Street Fighter';year:'1987';snd:1;hi:false;zip:'sf';grid:62;company:'Capcom';rom:[@sfighter_rom,nil];tipo:ARCADE or FIGHT),
  (name:'DigDug II';year:'1985';snd:1;hi:false;zip:'digdug2';grid:63;company:'Namco';rom:[@digdug2_rom,nil];tipo:ARCADE or MAZE),
  (name:'Super Pacman';year:'1985';snd:1;hi:false;zip:'superpac';grid:64;company:'Namco';rom:[@spacman_rom,nil];tipo:ARCADE or MAZE),
  (name:'Galaga';year:'1981';snd:3;hi:false;zip:'galaga';grid:65;company:'Namco';rom:[@galaga_rom,@namco_54xx_rom,nil];samples:[@galaga_samples,nil];tipo:ARCADE or SHOT),
  (name:'Xain''d Sleena';year:'1986';snd:1;hi:false;zip:'xsleena';grid:66;company:'Technos';rom:[@xain_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Hard Head';year:'1988';snd:1;hi:false;zip:'hardhead';grid:67;company:'Suna';rom:[@hardhead_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Hard Head 2';year:'1989';snd:1;hi:false;zip:'hardhea2';grid:68;company:'Suna';rom:[@hardhead2_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Saboten Bombers';year:'1992';snd:1;hi:false;zip:'sabotenb';grid:69;company:'NMK';rom:[@sbombers_rom,nil];tipo:ARCADE or MAZE),
  (name:'New Rally X';year:'1981';snd:3;hi:false;zip:'nrallyx';grid:70;company:'Namco';rom:[@nrallyx_rom,nil];samples:[@rallyx_samples,nil];tipo:ARCADE or DRIVE or MAZE),
  (name:'Bomb Jack Twin';year:'1993';snd:1;hi:false;zip:'bjtwin';grid:71;company:'NMK';rom:[@bjtwin_rom,nil];tipo:ARCADE or MAZE),
  (name:'Spelunker';year:'1985';snd:1;hi:false;zip:'spelunkr';grid:72;company:'Broderbound';rom:[@spelunkr_rom,nil];tipo:ARCADE or MAZE),
  (name:'Spelunker II';year:'1986';snd:1;hi:false;zip:'spelunk2';grid:73;company:'Broderbound';rom:[@spelunkr2_rom,nil];tipo:ARCADE or MAZE),
  (name:'Lode Runner';year:'1984';snd:1;hi:false;zip:'ldrun';grid:74;company:'Irem';rom:[@ldrun_rom,nil];tipo:ARCADE or MAZE),
  (name:'Lode Runner II';year:'1984';snd:1;hi:false;zip:'ldrun2';grid:75;company:'Irem';rom:[@ldrun2_rom,nil];tipo:ARCADE or MAZE),
  (name:'Knuckle Joe';year:'1985';snd:1;hi:false;zip:'kncljoe';grid:76;company:'Taito';rom:[@knjoe_rom,nil];tipo:ARCADE or FIGHT),
  (name:'Wardner';year:'1987';snd:1;hi:false;zip:'wardner';grid:77;company:'Taito';rom:[@wardner_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Big Karnak';year:'1991';snd:1;hi:false;zip:'bigkarnk';grid:78;company:'Gaelco';rom:[@bigkarnak_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Exed-Exes';year:'1985';snd:1;hi:false;zip:'exedexes';grid:79;company:'Capcom';rom:[@exedexes_rom,nil];tipo:ARCADE or SHOT),
  (name:'Gun.Smoke';year:'1985';snd:1;hi:false;zip:'gunsmoke';grid:80;company:'Capcom';rom:[@gunsmoke_rom,nil];tipo:ARCADE or RUN_GUN or SHOT),
  (name:'1942';year:'1984';snd:1;hi:false;zip:'1942';grid:81;company:'Capcom';rom:[@hw1942_rom,nil];tipo:ARCADE or SHOT),
  (name:'1943';year:'1987';snd:1;hi:false;zip:'1943';grid:82;company:'Capcom';rom:[@hw1943_rom,@hw1943_mcu,nil];tipo:ARCADE or SHOT),
  (name:'1943 Kai';year:'1987';snd:1;hi:false;zip:'1943kai';grid:83;company:'Capcom';rom:[@hw1943kai_rom,@hw1943_mcu,nil];tipo:ARCADE or SHOT),
  (name:'Jail Break';year:'1986';snd:1;hi:false;zip:'jailbrek';grid:84;company:'Konami';rom:[@jailbreak_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Circus Charlie';year:'1984';snd:1;hi:false;zip:'circusc';grid:85;company:'Konami';rom:[@circusc_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Iron Horse';year:'1986';snd:1;hi:false;zip:'ironhors';grid:86;company:'Konami';rom:[@ironhorse_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'R-Type';year:'1987';snd:1;hi:false;zip:'rtype';grid:87;company:'Irem';rom:[@rtype_rom,nil];tipo:ARCADE or SHOT),
  (name:'MS. Pac-man';year:'1981';snd:1;hi:false;zip:'mspacman';grid:88;company:'Namco';rom:[@mspacman_rom,@pacman_sound,@pacman_pal,nil];tipo:ARCADE or MAZE),
  (name:'Break Thru';year:'1986';snd:1;hi:false;zip:'brkthru';grid:89;company:'Data East';rom:[@brkthru_rom,nil];tipo:ARCADE or RUN_GUN or DRIVE),
  (name:'Darwin 4078';year:'1986';snd:1;hi:false;zip:'darwin';grid:90;company:'Data East';rom:[@darwin_rom,nil];tipo:ARCADE or SHOT),
  (name:'Super Real Darwin';year:'1987';snd:1;hi:false;zip:'srdarwin';grid:91;company:'Data East';rom:[@superdarwin_rom,nil];tipo:ARCADE or SHOT),
  (name:'Double Dragon';year:'1987';snd:1;hi:false;zip:'ddragon';grid:92;company:'Taito';rom:[@ddragon_rom,nil];tipo:ARCADE or FIGHT),
  (name:'Mr. Do!';year:'1982';snd:1;hi:false;zip:'mrdo';grid:93;company:'Universal';rom:[@mrdo_rom,nil];tipo:ARCADE or MAZE),
  (name:'The Glob';year:'1983';snd:1;hi:false;zip:'theglob';grid:94;company:'Epos';rom:[@theglob_rom,@theglob_pal,nil];tipo:ARCADE or MAZE),
  (name:'Super Glob';year:'1983';snd:1;hi:false;zip:'suprglob';grid:95;company:'Epos';rom:[@superglob_rom,@theglob_pal,nil];tipo:ARCADE or MAZE),
  (name:'Double Dragon II - The Revenge';year:'1988';snd:1;hi:false;zip:'ddragon2';grid:96;company:'Technos';rom:[@ddragon2_rom,nil];tipo:ARCADE or FIGHT),
  (name:'Silk Worm';year:'1988';snd:1;hi:false;zip:'silkworm';grid:97;company:'Tecmo';rom:[@sw_rom,nil];tipo:ARCADE or RUN_GUN or SHOT or DRIVE),
  (name:'Tiger Heli';year:'1985';snd:1;hi:false;zip:'tigerh';grid:98;company:'Taito';rom:[@tigerh_rom,nil];tipo:ARCADE or SHOT),
  (name:'Slap Fight';year:'1986';snd:1;hi:false;zip:'slapfigh';grid:99;company:'Taito';rom:[@slapfight_rom,nil];tipo:ARCADE or SHOT),
  (name:'The Legend of Kage';year:'1984';snd:1;hi:false;zip:'lkage';grid:100;company:'Taito';rom:[@legendkage_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Thunder Hoop';year:'1992';snd:1;hi:false;zip:'thoop';grid:101;company:'Gaelco';rom:[@thoop_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Cabal';year:'1988';snd:1;hi:false;zip:'cabal';grid:102;company:'TAD';rom:[@cabal_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Ghouls''n Ghosts';year:'1988';snd:1;hi:false;zip:'ghouls';grid:103;company:'Capcom';rom:[@ghouls_rom1,nil];tipo:ARCADE or RUN_GUN),
  (name:'Final Fight';year:'1989';snd:1;hi:false;zip:'ffight';grid:104;company:'Capcom';rom:[@ffight_rom1,nil];tipo:ARCADE or FIGHT),
  (name:'The King of Dragons';year:'1991';snd:1;hi:false;zip:'kod';grid:105;company:'Capcom';rom:[@kod_rom1,nil];tipo:ARCADE or FIGHT),
  (name:'Street Fighter II - The World Warrior';year:'1991';snd:1;hi:false;zip:'sf2';grid:106;company:'Capcom';rom:[@sf2_rom1,nil];tipo:ARCADE or FIGHT),
  (name:'Strider';year:'1989';snd:1;hi:false;zip:'strider';grid:107;company:'Capcom';rom:[@strider_rom1,nil];tipo:ARCADE or RUN_GUN),
  (name:'Three Wonders';year:'1991';snd:1;hi:false;zip:'3wonders';grid:108;company:'Capcom';rom:[@wonder3_rom1,nil];tipo:ARCADE or RUN_GUN),
  (name:'Captain Commando';year:'1991';snd:1;hi:false;zip:'captcomm';grid:109;company:'Capcom';rom:[@ccommando_rom1,nil];tipo:ARCADE or RUN_GUN),
  (name:'Knights of the Round';year:'1991';snd:1;hi:false;zip:'knights';grid:110;company:'Capcom';rom:[@knights_rom1,nil];tipo:ARCADE or RUN_GUN),
  (name:'Street Fighter II'': Champion Edition';year:'1992';snd:1;hi:false;zip:'sf2ce';grid:111;company:'Capcom';rom:[@sf2ce_rom1,nil];tipo:ARCADE or FIGHT),
  (name:'Cadillacs and Dinosaurs';year:'1992';snd:1;hi:false;zip:'dino';grid:112;company:'Capcom';rom:[@dino_rom1,nil];tipo:ARCADE or FIGHT),
  (name:'The Punisher';year:'1993';snd:1;hi:false;zip:'punisher';grid:113;company:'Capcom';rom:[@punisher_rom1,nil];tipo:ARCADE or FIGHT),
  (name:'Shinobi';year:'1987';snd:1;hi:false;zip:'shinobi';grid:114;company:'Sega';rom:[@shinobi_rom,@shinobi_n7751,nil];tipo:ARCADE or RUN_GUN),
  (name:'Alex Kidd';year:'1986';snd:1;hi:false;zip:'alexkidd';grid:115;company:'Sega';rom:[@alexkid_rom,@shinobi_n7751,nil];tipo:ARCADE or RUN_GUN),
  (name:'Fantasy Zone';year:'1986';snd:1;hi:false;zip:'fantzone';grid:116;company:'Sega';rom:[@fantzone_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Time Pilot ''84';year:'1984';snd:1;hi:false;zip:'tp84';grid:117;company:'Konami';rom:[@tp84_rom,nil];tipo:ARCADE or SHOT),
  (name:'Tutankham';year:'1982';snd:1;hi:false;zip:'tutankhm';grid:118;company:'Konami';rom:[@tutan_rom,nil];tipo:ARCADE or MAZE),
  (name:'Pang';year:'1989';snd:1;hi:false;zip:'pang';grid:119;company:'Capcom';rom:[@pang_rom,nil];tipo:ARCADE or SHOT),
  (name:'Ninja Kid II';year:'1987';snd:1;hi:false;zip:'ninjakd2';grid:120;company:'UPL';rom:[@ninjakid2_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Ark Area';year:'1988';snd:1;hi:false;zip:'arkarea';grid:121;company:'UPL';rom:[@aarea_rom,nil];tipo:ARCADE or SHOT),
  (name:'Mutant Night';year:'1987';snd:1;hi:false;zip:'mnight';grid:122;company:'UPL';rom:[@mnight_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Sky Kid';year:'1985';snd:1;hi:false;zip:'skykid';grid:123;company:'Namco';rom:[@skykid_rom,nil];tipo:ARCADE or SHOT),
  (name:'Rolling Thunder';year:'1986';snd:1;hi:false;zip:'rthunder';grid:124;company:'Namco';rom:[@rthunder_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Hopping Mappy';year:'1986';snd:1;hi:false;zip:'hopmappy';grid:125;company:'Namco';rom:[@hopmappy_rom,nil];tipo:ARCADE or MAZE),
  (name:'Sky Kid Deluxe';year:'1986';snd:1;hi:false;zip:'skykiddx';grid:126;company:'Namco';rom:[@skykiddx_rom,nil];tipo:ARCADE or SHOT),
  (name:'Roc''n Rope';year:'1983';snd:1;hi:false;zip:'rocnrope';grid:127;company:'Konami';rom:[@rocnrope_rom,nil];tipo:ARCADE or MAZE),
  (name:'Repulse';year:'1985';snd:1;hi:false;zip:'repulse';grid:128;company:'Crux/Sega';rom:[@repulse_rom,nil];tipo:ARCADE or SHOT),
  (name:'The NewZealand Story';year:'1988';snd:1;hi:false;zip:'tnzs';grid:129;company:'Taito';rom:[@tnzs_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Insector X';year:'1989';snd:1;hi:false;zip:'insectx';grid:130;company:'Taito';rom:[@insectorx_rom,nil];tipo:ARCADE or SHOT),
  (name:'Pacland';year:'1984';snd:1;hi:false;zip:'pacland';grid:131;company:'Namco';rom:[@pacland_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Mario Bros.';year:'1983';snd:2;hi:false;zip:'mario';grid:132;company:'Nintendo';rom:[@mario_rom,nil];samples:[@mario_samples,nil];tipo:ARCADE or MAZE),
  (name:'Solomon''s Key';year:'1986';snd:1;hi:false;zip:'solomon';grid:133;company:'Tecmo';rom:[@solomon_rom,nil];tipo:ARCADE or MAZE),
  (name:'Combat School';year:'1988';snd:1;hi:false;zip:'combatsc';grid:134;company:'Konami';rom:[@combatsc_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Heavy Unit';year:'1988';snd:1;hi:false;zip:'hvyunit';grid:135;company:'Taito';rom:[@hvyunit_cpu1,nil];tipo:ARCADE or SHOT),
  (name:'P.O.W. - Prisoners of War';year:'1988';snd:1;hi:false;zip:'pow';grid:136;company:'SNK';rom:[@pow_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Street Smart';year:'1988';snd:1;hi:false;zip:'streetsm';grid:137;company:'SNK';rom:[@streetsm_rom,nil];tipo:ARCADE or FIGHT),
  (name:'P47 - Phantom Fighter';year:'1989';snd:1;hi:false;zip:'p47';grid:138;company:'Jaleco';rom:[@p47_rom,nil];tipo:ARCADE or SHOT),
  (name:'Rod-Land';year:'1990';snd:1;hi:false;zip:'rodland';grid:139;company:'Jaleco';rom:[@rodland_rom,nil];tipo:ARCADE or MAZE),
  (name:'Saint Dragon';year:'1989';snd:1;hi:false;zip:'stdragon';grid:140;company:'Jaleco';rom:[@stdragon_rom,nil];tipo:ARCADE or SHOT),
  (name:'Time Pilot';year:'1982';snd:1;hi:false;zip:'timeplt';grid:141;company:'Konami';rom:[@timepilot_rom,nil];tipo:ARCADE or SHOT),
  (name:'Pengo';year:'1982';snd:1;hi:false;zip:'pengo';grid:142;company:'Sega';rom:[@pengo_rom,nil];tipo:ARCADE or MAZE),
  (name:'Scramble';year:'1981';snd:1;hi:false;zip:'scramble';grid:143;company:'Konami';rom:[@scramble_rom,nil];tipo:ARCADE or SHOT),
  (name:'Super Cobra';year:'1981';snd:1;hi:false;zip:'scobra';grid:144;company:'Konami';rom:[@scobra_rom,nil];tipo:ARCADE or SHOT),
  (name:'Amidar';year:'1982';snd:1;hi:false;zip:'amidar';grid:145;company:'Konami';rom:[@amidar_rom,nil];tipo:ARCADE or MAZE),
  (name:'Twin Cobra';year:'1987';snd:1;hi:false;zip:'twincobr';grid:146;company:'Taito';rom:[@twincobr_rom,nil];tipo:ARCADE or SHOT),
  (name:'Flying Shark';year:'1987';snd:1;hi:false;zip:'fshark';grid:147;company:'Taito';rom:[@fshark_rom,nil];tipo:ARCADE or SHOT),
  (name:'Jr. Pac-Man';year:'1983';snd:1;hi:false;zip:'jrpacman';grid:148;company:'Bally Midway';rom:[@jrpacman_rom,nil];tipo:ARCADE or MAZE),
  (name:'Ikari III - The Rescue';year:'1989';snd:1;hi:false;zip:'ikari3';grid:149;company:'SNK';rom:[@ikari3_rom,nil];tipo:ARCADE or FIGHT),
  (name:'Search and Rescue';year:'1989';snd:1;hi:false;zip:'searchar';grid:150;company:'SNK';rom:[@sar_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Choplifter';year:'1985';snd:1;hi:false;zip:'choplift';grid:151;company:'Sega';rom:[@choplift_rom,nil];tipo:ARCADE or SHOT or RUN_GUN),
  (name:'Mister Viking';year:'1983';snd:1;hi:false;zip:'mrviking';grid:152;company:'Sega';rom:[@mrviking_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Sega Ninja';year:'1985';snd:1;hi:false;zip:'seganinj';grid:153;company:'Sega';rom:[@seganinj_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Up''n Down';year:'1983';snd:1;hi:false;zip:'upndown';grid:154;company:'Sega';rom:[@upndown_rom,nil];tipo:ARCADE or DRIVE or MAZE),
  (name:'Flicky';year:'1984';snd:1;hi:false;zip:'flicky';grid:155;company:'Sega';rom:[@flicky_rom,nil];tipo:ARCADE or MAZE),
  (name:'Robocop';year:'1988';snd:1;hi:false;zip:'robocop';grid:156;company:'Data East';rom:[@robocop_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Baddudes vs. DragonNinja';year:'1988';snd:1;hi:false;zip:'baddudes';grid:157;company:'Data East';rom:[@baddudes_rom,nil];tipo:ARCADE or FIGHT or RUN_GUN),
  (name:'Hippodrome';year:'1989';snd:1;hi:false;zip:'hippodrm';grid:158;company:'Data East';rom:[@hippo_rom,nil];tipo:ARCADE or FIGHT),
  (name:'Tumble Pop';year:'1991';snd:1;hi:false;zip:'tumblep';grid:159;company:'Data East';rom:[@tumblep_rom,nil];tipo:ARCADE or MAZE),
  (name:'Funky Jet';year:'1992';snd:1;hi:false;zip:'funkyjet';grid:160;company:'Mitchell';rom:[@funkyjet_rom,nil];tipo:ARCADE or MAZE),
  (name:'Super Burger Time';year:'1990';snd:1;hi:false;zip:'supbtime';grid:161;company:'Data East';rom:[@supbtime_rom,nil];tipo:ARCADE),
  (name:'Caveman Ninja';year:'1991';snd:1;hi:false;zip:'cninja';grid:162;company:'Data East';rom:[@cninja_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Robocop 2';year:'1991';snd:1;hi:false;zip:'robocop2';grid:163;company:'Data East';rom:[@robocop2_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Diet Go Go';year:'1992';snd:1;hi:false;zip:'dietgo';grid:164;company:'Data East';rom:[@dietgo_rom,nil];tipo:ARCADE or MAZE),
  (name:'Act-Fancer Cybernetick Hyper Weapon';year:'1989';snd:1;hi:false;zip:'actfancr';grid:165;company:'Data East';rom:[@actfancer_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Arabian';year:'1983';snd:1;hi:false;zip:'arabian';grid:166;company:'Sun Electronics';rom:[@arabian_rom,nil];tipo:ARCADE or MAZE),
  (name:'Dig Dug';year:'1982';snd:1;hi:false;zip:'digdug';grid:167;company:'Namco';rom:[@digdug_rom,@namco_53xx_rom,nil];tipo:ARCADE or MAZE),
  (name:'Donkey Kong Jr.';year:'1982';snd:2;hi:false;zip:'dkongjr';grid:168;company:'Nintendo';rom:[@dkongjr_rom,nil];samples:[@dkongjr_samples,nil];tipo:ARCADE or MAZE),
  (name:'Donkey Kong 3';year:'1983';snd:1;hi:false;zip:'dkong3';grid:169;company:'Nintendo';rom:[@dkong3_rom,nil];tipo:ARCADE or MAZE),
  (name:'Pirate Ship Higemaru';year:'1984';snd:1;hi:false;zip:'higemaru';grid:170;company:'Capcom';rom:[@higemaru_rom,nil];tipo:ARCADE or MAZE),
  (name:'Bagman';year:'1982';snd:4;hi:false;zip:'bagman';grid:171;company:'Valadon Automation';rom:[@bagman_rom,nil];tipo:ARCADE or MAZE),
  (name:'Super Bagman';year:'1984';snd:4;hi:false;zip:'sbagman';grid:172;company:'Valadon Automation';rom:[@sbagman_rom,nil];tipo:ARCADE or MAZE),
  (name:'Squash';year:'1992';snd:1;hi:false;zip:'squash';grid:173;company:'Gaelco';rom:[@squash_rom,nil];tipo:ARCADE or SPORT),
  (name:'Biomechanical Toy';year:'1995';snd:1;hi:false;zip:'biomtoy';grid:174;company:'Gaelco';rom:[@biomtoy_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Congo Bongo';year:'1983';snd:3;hi:false;zip:'congo';grid:175;company:'Sega';rom:[@congo_rom,nil];samples:[@congo_samples,nil];tipo:ARCADE or MAZE),
  (name:'Kangaroo';year:'1982';snd:1;hi:false;zip:'kangaroo';grid:176;company:'Sun Electronics';rom:[@kangaroo_rom,nil];tipo:ARCADE or MAZE),
  (name:'Bionic Commando';year:'1987';snd:1;hi:false;zip:'bionicc';grid:177;company:'Capcom';rom:[@bionicc_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'WWF Superstar';year:'1989';snd:1;hi:false;zip:'wwfsstar';grid:178;company:'Technos Japan';rom:[@wwfsstar_rom,nil];tipo:ARCADE or SPORT),
  (name:'Rainbow Islands';year:'1987';snd:1;hi:false;zip:'rbisland';grid:179;company:'Taito';rom:[@rainbow_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Rainbow Islands Extra';year:'1987';snd:1;hi:false;zip:'rbislande';grid:180;company:'Taito';rom:[@rainbowe_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Volfied';year:'1989';snd:1;hi:false;zip:'volfied';grid:181;company:'Taito';rom:[@volfied_rom,nil];tipo:ARCADE or MAZE),
  (name:'Operation Wolf';year:'1987';snd:1;hi:false;zip:'opwolf';grid:182;company:'Taito';rom:[@opwolf_rom,nil];tipo:ARCADE or RUN_GUN or SHOT),
  (name:'Super Pang';year:'1990';snd:1;hi:false;zip:'spang';grid:183;company:'Capcom';rom:[@spang_rom,nil];tipo:ARCADE or SHOT),
  (name:'Outrun';year:'1989';snd:1;hi:false;zip:'outrun';grid:184;company:'Sega';rom:[@outrun_rom,nil];tipo:ARCADE or DRIVE),
  (name:'Elevator Action';year:'1983';snd:1;hi:false;zip:'elevator';grid:185;company:'Taito';rom:[@elevator_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Alien Syndrome';year:'1988';snd:1;hi:false;zip:'aliensyn';grid:186;company:'Sega';rom:[@alien_rom,@shinobi_n7751,nil];tipo:ARCADE or RUN_GUN),
  (name:'Wonder Boy III - Monster Lair';year:'1987';snd:1;hi:false;zip:'wb3';grid:187;company:'Sega';rom:[@wb3_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Zaxxon';year:'1982';snd:2;hi:false;zip:'zaxxon';grid:188;company:'Sega';rom:[@zaxxon_rom,nil];samples:[@zaxxon_samples,nil];tipo:ARCADE or SHOT),
  (name:'Jungle King';year:'1982';snd:1;hi:false;zip:'junglek';grid:189;company:'Taito';rom:[@junglek_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Hammerin'' Harry';year:'1990';snd:1;hi:false;zip:'hharry';grid:190;company:'Irem';rom:[@hharry_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'R-Type II';year:'1989';snd:1;hi:false;zip:'rtype2';grid:191;company:'Irem';rom:[@rtype2_rom,nil];tipo:ARCADE or SHOT),
  (name:'The Tower of Druaga';year:'1984';snd:1;hi:false;zip:'todruaga';grid:192;company:'Namco';rom:[@todruaga_rom,nil];tipo:ARCADE or MAZE),
  (name:'Motos';year:'1985';snd:1;hi:false;zip:'motos';grid:193;company:'Namco';rom:[@motos_rom,nil];tipo:ARCADE or MAZE),
  (name:'Dragon Buster';year:'1984';snd:1;hi:false;zip:'drgnbstr';grid:194;company:'Namco';rom:[@drgnbstr_rom,nil];tipo:ARCADE or MAZE or RUN_GUN),
  (name:'Vulgus';year:'1984';snd:1;hi:false;zip:'vulgus';grid:195;company:'Capcom';rom:[@vulgus_rom,nil];tipo:ARCADE or SHOT),
  (name:'Double Dragon 3 - The Rosetta Stone';year:'1990';snd:1;hi:false;zip:'ddragon3';grid:196;company:'Technos';rom:[@ddragon3_rom,nil];tipo:ARCADE or FIGHT),
  (name:'Block Out';year:'1990';snd:1;hi:false;zip:'blockout';grid:197;company:'Technos';rom:[@blockout_rom,nil];tipo:ARCADE),
  (name:'Tetris (Sega)';year:'1988';snd:1;hi:false;zip:'tetris';grid:198;company:'Sega';rom:[@tetris_rom,nil];tipo:ARCADE),
  (name:'Food Fight';year:'1982';snd:1;hi:false;zip:'foodf';grid:199;company:'Atari';rom:[@foodf_rom,nil];tipo:ARCADE or MAZE),
  (name:'Snap Jack';year:'1982';snd:1;hi:false;zip:'snapjack';grid:200;company:'Universal';rom:[@snapjack_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Cosmic Avenger';year:'1981';snd:1;hi:false;zip:'cavenger';grid:201;company:'Universal';rom:[@cavenger_rom,nil];tipo:ARCADE or SHOT),
  (name:'Pleiads';year:'1981';snd:0;hi:false;zip:'pleiads';grid:202;company:'Tehkan';rom:[@pleiads_rom,nil];tipo:ARCADE or SHOT),
  (name:'Mr. Goemon';year:'1986';snd:1;hi:false;zip:'mrgoemon';grid:203;company:'Konami';rom:[@mrgoemon_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Nemesis';year:'1985';snd:1;hi:false;zip:'nemesis';grid:204;company:'Konami';rom:[@nemesis_rom,@nemesis_rom_k005289,nil];tipo:ARCADE or SHOT),
  (name:'Twinbee';year:'1985';snd:1;hi:false;zip:'twinbee';grid:205;company:'Konami';rom:[@twinbee_rom,@nemesis_rom_k005289,@gx400_bios,@gx400_sound,nil];tipo:ARCADE or SHOT),
  (name:'Pirates';year:'1994';snd:1;hi:false;zip:'pirates';grid:206;company:'NIX';rom:[@pirates_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Genix Family';year:'1994';snd:1;hi:false;zip:'genix';grid:207;company:'NIX';rom:[@genix_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Juno First';year:'1983';snd:1;hi:false;zip:'junofrst';grid:208;company:'Konami';rom:[@junofrst_rom,nil];tipo:ARCADE or SHOT),
  (name:'Gyruss';year:'1983';snd:1;hi:false;zip:'gyruss';grid:209;company:'Konami';rom:[@gyruss_rom,nil];tipo:ARCADE or SHOT),
  (name:'Boogie Wings';year:'1992';snd:1;hi:false;zip:'boogwing';grid:210;company:'Data East';rom:[@boogwing_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Free Kick';year:'1987';snd:1;hi:false;zip:'freekick';grid:211;company:'Nihon System';rom:[@freekick_rom,nil];tipo:ARCADE or SPORT),
  (name:'Pinball Action';year:'1985';snd:1;hi:false;zip:'pbaction';grid:212;company:'Tehkan';rom:[@pinballaction_rom,nil];tipo:ARCADE),
  (name:'Renegade';year:'1986';snd:1;hi:false;zip:'renegade';grid:213;company:'Technos Japan';rom:[@renegade_rom,nil];tipo:ARCADE or FIGHT),
  (name:'Teenage Mutant Ninja Turtles';year:'1989';snd:1;hi:false;zip:'tmnt';grid:214;company:'Konami';rom:[@tmnt_rom,nil];tipo:ARCADE or FIGHT),
  (name:'Sunset Riders';year:'1991';snd:1;hi:false;zip:'ssriders';grid:215;company:'Konami';rom:[@ssriders_rom,nil];tipo:ARCADE or RUN_GUN or FIGHT),
  (name:'Gradius III';year:'1991';snd:1;hi:false;zip:'gradius3';grid:216;company:'Konami';rom:[@gradius3_rom,nil];tipo:ARCADE or SHOT),
  (name:'Space Invaders';year:'1978';snd:2;hi:false;zip:'invaders';grid:217;company:'Taito';rom:[@spaceinv_rom,nil];samples:[@spaceinv_samples,nil];tipo:ARCADE or SHOT),
  (name:'Centipede';year:'1980';snd:1;hi:false;zip:'centiped';grid:218;company:'Atari';rom:[@centipede_rom,nil];tipo:ARCADE or SHOT),
  (name:'Karnov';year:'1987';snd:1;hi:false;zip:'karnov';grid:219;company:'Data East';rom:[@karnov_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Chelnov';year:'1987';snd:1;hi:false;zip:'chelnov';grid:220;company:'Data East';rom:[@chelnov_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Aliens';year:'1990';snd:1;hi:false;zip:'aliens';grid:221;company:'Konami';rom:[@aliens_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Super Contra';year:'1988';snd:1;hi:false;zip:'scontra';grid:222;company:'Konami';rom:[@scontra_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Gang Busters';year:'1988';snd:1;hi:false;zip:'gbusters';grid:223;company:'Konami';rom:[@gbusters_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Thunder Cross';year:'1988';snd:1;hi:false;zip:'thunderx';grid:224;company:'Konami';rom:[@thunderx_rom,nil];tipo:ARCADE or SHOT),
  (name:'The Simpsons';year:'1991';snd:1;hi:false;zip:'simpsons';grid:225;company:'Konami';rom:[@simpsons_rom,nil];tipo:ARCADE or RUN_GUN or FIGHT),
  (name:'Track & Field';year:'1983';snd:1;hi:false;zip:'trackfld';grid:226;company:'Konami';rom:[@trackfield_rom,nil];tipo:ARCADE or SPORT),
  (name:'Hyper Sports';year:'1984';snd:1;hi:false;zip:'hyperspt';grid:227;company:'Konami';rom:[@hypersports_rom,nil];tipo:ARCADE or SPORT),
  (name:'Megazone';year:'1983';snd:1;hi:false;zip:'megazone';grid:228;company:'Konami';rom:[@megazone_rom,nil];tipo:ARCADE or SHOT),
  (name:'Space Fire Bird';year:'1980';snd:4;hi:false;zip:'spacefb';grid:229;company:'Nintendo';rom:[@spacefb_rom,nil];samples:[@spacefb_samples,nil];tipo:ARCADE or SHOT),
  (name:'Ajax';year:'1987';snd:1;hi:false;zip:'ajax';grid:230;company:'Konami';rom:[@ajax_rom,nil];tipo:ARCADE or SHOT),
  (name:'Xevious';year:'1982';snd:3;hi:false;zip:'xevious';grid:231;company:'Namco';rom:[@xevious_rom,@namco_50xx_rom,@namco_54xx_rom,nil];samples:[@xevious_samples,nil];tipo:ARCADE or SHOT),
  (name:'The Combatribes';year:'1990';snd:1;hi:false;zip:'ctribe';grid:232;company:'Technos';rom:[@ctribe_rom,nil];tipo:ARCADE or FIGHT),
  (name:'Lunar Lander';year:'1979';snd:0;hi:false;zip:'llander';grid:233;company:'Atari';rom:[@llander_rom,nil];tipo:ARCADE),
  (name:'Crush Roller';year:'1981';snd:1;hi:false;zip:'crush';grid:234;company:'Alpha Denshi Co./Kural Samno Electric, Ltd.';rom:[@crush_rom,@pacman_sound,nil];tipo:ARCADE or MAZE),
  (name:'Vendetta';year:'1991';snd:1;hi:false;zip:'vendetta';grid:235;company:'Konami';rom:[@vendetta_rom,nil];tipo:ARCADE or FIGHT),
  (name:'Gauntlet';year:'1985';snd:1;hi:false;zip:'gauntlet';grid:236;company:'Atari';rom:[@gauntlet_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Sauro';year:'1987';snd:1;hi:false;zip:'sauro';grid:237;company:'Tecfri';rom:[@sauro_rom,nil];tipo:ARCADE or SHOT),
  (name:'Crazy Climber';year:'1980';snd:1;hi:false;zip:'cclimber';grid:238;company:'Nichibutsu';rom:[@cclimber_rom,nil];tipo:ARCADE),
  (name:'Return of the Invaders';year:'1985';snd:1;hi:false;zip:'retofinv';grid:239;company:'Taito';rom:[@retofinv_rom,nil];tipo:ARCADE or SHOT),
  (name:'Tetris (Atari)';year:'1988';snd:1;hi:false;zip:'atetris';grid:240;company:'Atari Games';rom:[@tetrisa_rom,nil];tipo:ARCADE),
  (name:'Ikari Warriors';year:'1986';snd:1;hi:false;zip:'ikari';grid:241;company:'SNK';rom:[@ikari_main,nil];tipo:ARCADE or RUN_GUN),
  (name:'Athena';year:'1986';snd:1;hi:false;zip:'athena';grid:242;company:'SNK';rom:[@athena_main,nil];tipo:ARCADE or RUN_GUN),
  (name:'T.N.K III';year:'1986';snd:1;hi:false;zip:'tnk3';grid:243;company:'SNK';rom:[@tnk3_main,nil];tipo:ARCADE or RUN_GUN),
  (name:'Peter Pack Rat';year:'1984';snd:1;hi:false;zip:'peterpak';grid:244;company:'Atari';rom:[@peterpak_rom,@atari_sys1_bios,@atari_sys1_char,nil];tipo:ARCADE),
  (name:'Gauntlet II';year:'1986';snd:1;hi:false;zip:'gaunt2';grid:245;company:'Atari';rom:[@gauntlet2_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Defender';year:'1980';snd:1;hi:false;zip:'defender';grid:246;company:'Williams';rom:[@defender_rom,nil];tipo:ARCADE or SHOT),
  (name:'Fire Ball';year:'1992';snd:1;hi:false;zip:'fball';grid:247;company:'FM Works';rom:[@fball_rom,nil];tipo:ARCADE or MAZE),
  (name:'Mayday';year:'1980';snd:1;hi:false;zip:'mayday';grid:248;company:'Williams';rom:[@mayday_rom,nil];tipo:ARCADE or SHOT),
  (name:'Colony 7';year:'1981';snd:1;hi:false;zip:'colony7';grid:249;company:'Williams';rom:[@colony7_rom,nil];tipo:ARCADE or SHOT),
  (name:'Bosconian';year:'1981';snd:3;hi:false;zip:'bosco';grid:250;company:'Namco';rom:[@bosco_rom,@namco_50xx_rom,@namco_54xx_rom,nil];samples:[@bosco_samples,nil];tipo:ARCADE or SHOT),
  (name:'HangOn Jr.';year:'1985';snd:1;hi:false;zip:'hangonjr';grid:251;company:'Sega';rom:[@hangonjr_rom,nil];tipo:ARCADE or SPORT or DRIVE),
  (name:'Slap Shooter';year:'1986';snd:1;hi:false;zip:'slapshtr';grid:252;company:'Sega';rom:[@slapshtr_rom,nil];tipo:ARCADE or SPORT),
  (name:'Fantasy Zone II: The Tears of Opa-Opa';year:'1988';snd:1;hi:false;zip:'fantzn2';grid:253;company:'Sega';rom:[@fantzn2_rom,nil];tipo:ARCADE or SHOT),
  (name:'Opa Opa';year:'1987';snd:1;hi:false;zip:'opaopa';grid:254;company:'Sega';rom:[@opaopa_rom,nil];tipo:ARCADE or MAZE),
  (name:'Tetris (Sega System E)';year:'1988';snd:1;hi:false;zip:'tetrisse';grid:255;company:'Sega';rom:[@tetrisse_rom,nil];tipo:ARCADE),
  (name:'Transformer';year:'1986';snd:1;hi:false;zip:'transfrm';grid:256;company:'Sega';rom:[@transfrm_rom,nil];tipo:ARCADE or SHOT),
  (name:'Riddle of Pythagoras';year:'1986';snd:1;hi:false;zip:'ridleofp';grid:257;company:'Sega';rom:[@ridleofp_rom,nil];tipo:ARCADE or MAZE),
  (name:'Route 16';year:'1981';snd:1;hi:false;zip:'route16';grid:258;company:'Sun Electronics';rom:[@route16_cpu1,nil];tipo:ARCADE or DRIVE),
  (name:'Speak & Rescue';year:'1980';snd:1;hi:false;zip:'speakres';grid:259;company:'Sun Electronics';rom:[@speakres_cpu1,nil];tipo:ARCADE or SHOT),
  (name:'Galactic Warriors';year:'1985';snd:1;hi:false;zip:'gwarrior';grid:260;company:'Konami';rom:[@gwarrior_rom,@nemesis_rom_k005289,@gx400_bios,@gx400_sound,nil];tipo:ARCADE or FIGHT),
  (name:'Salamander';year:'1986';snd:1;hi:false;zip:'salamand';grid:261;company:'Konami';rom:[@salamander_rom,nil];tipo:ARCADE or SHOT),
  (name:'Bad Lands';year:'1989';snd:1;hi:false;zip:'badlands';grid:262;company:'Atari';rom:[@badlands_rom,nil];tipo:ARCADE or DRIVE),
  (name:'Indiana Jones and the Temple of Doom';year:'1985';snd:1;hi:false;zip:'indytemp';grid:263;company:'Atari';rom:[@indy_rom,@atari_sys1_bios,@atari_sys1_char,nil];tipo:ARCADE or RUN_GUN),
  (name:'Marble Madness';year:'1984';snd:1;hi:false;zip:'marble';grid:264;company:'Atari';rom:[@marble_rom,@atari_sys1_bios,@atari_sys1_char,nil];tipo:ARCADE or MAZE),
  (name:'Soldier Girl Amazon';year:'1986';snd:1;hi:false;zip:'amazon';grid:265;company:'Nichibutsu';rom:[@amazon_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Cosmo Police Galivan';year:'1985';snd:1;hi:false;zip:'galivan';grid:266;company:'Nichibutsu';rom:[@galivan_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Ufo Robo Dangar';year:'1986';snd:1;hi:false;zip:'dangar';grid:267;company:'Nichibutsu';rom:[@dangar_rom,nil];tipo:ARCADE or SHOT),
  (name:'Last Duel';year:'1988';snd:1;hi:false;zip:'lastduel';grid:268;company:'Capcom';rom:[@lastduel_rom,nil];tipo:ARCADE or DRIVE),
  (name:'Mad Gear';year:'1989';snd:1;hi:false;zip:'madgear';grid:269;company:'Capcom';rom:[@madgear_rom,nil];tipo:ARCADE or DRIVE),
  (name:'Led Storm Rally 2011';year:'1989';snd:1;hi:false;zip:'leds2011';grid:270;company:'Capcom';rom:[@leds2011_rom,nil];tipo:ARCADE or DRIVE),
  (name:'Gigas';year:'1986';snd:1;hi:false;zip:'gigas';grid:271;company:'Sega';rom:[@gigas_rom,@gigas_key,@gigas_pal,nil];tipo:ARCADE or MAZE),
  (name:'Gigas Mark II';year:'1986';snd:1;hi:false;zip:'gigasm2';grid:272;company:'Sega';rom:[@gigasm2_rom,@gigas_key,@gigas_pal,nil];tipo:ARCADE or MAZE),
  (name:'Omega';year:'1986';snd:1;hi:false;zip:'omega';grid:273;company:'Nihon System';rom:[@omega_rom,nil];tipo:ARCADE or MAZE),
  (name:'Perfect Billard';year:'1987';snd:1;hi:false;zip:'pbillrd';grid:274;company:'Nihon System';rom:[@pbillrd_rom,nil];tipo:ARCADE or SPORT),
  (name:'Armed F';year:'1988';snd:1;hi:false;zip:'armedf';grid:275;company:'Nichibutsu';rom:[@armedf_rom,nil];tipo:ARCADE or SHOT),
  (name:'Terra Force';year:'1987';snd:1;hi:false;zip:'terraf';grid:276;company:'Nichibutsu';rom:[@terraf_rom,nil];tipo:ARCADE or SHOT),
  (name:'Crazy Climber 2';year:'1988';snd:1;hi:false;zip:'cclimbr2';grid:277;company:'Nichibutsu';rom:[@cclimbr2_rom,nil];tipo:ARCADE),
  (name:'Legion - Spinner-87';year:'1987';snd:1;hi:false;zip:'legion';grid:278;company:'Nichibutsu';rom:[@legion_rom,nil];tipo:ARCADE or SHOT or DRIVE),
  (name:'ASO - Armored Scrum Object';year:'1985';snd:1;hi:false;zip:'aso';grid:279;company:'SNK';rom:[@aso_main,nil];tipo:ARCADE or SHOT),
  (name:'Fire Trap';year:'1986';snd:1;hi:false;zip:'firetrap';grid:280;company:'Woodplace Inc.';rom:[@firetrap_rom,nil];tipo:ARCADE),
  (name:'3x3 Puzzle';year:'1998';snd:1;hi:false;zip:'3x3puzzl';grid:281;company:'Ace Enterprise';rom:[@puzz3x3_rom,nil];tipo:ARCADE),
  (name:'Casanova';year:'199?';snd:1;hi:false;zip:'casanova';grid:282;company:'Promat';rom:[@casanova_rom,nil];tipo:ARCADE or MAZE),
  (name:'1945k III';year:'2000';snd:1;hi:false;zip:'1945kiii';grid:283;company:'Oriental Soft';rom:[@k31945_rom,nil];tipo:ARCADE or SHOT),
  (name:'96 Flag Rally';year:'2000';snd:1;hi:false;zip:'flagrall';grid:284;company:'Promat';rom:[@flagrall_rom,nil];tipo:ARCADE or DRIVE),
  (name:'Blood Bros.';year:'1990';snd:1;hi:false;zip:'bloodbro';grid:285;company:'TAD Corporation';rom:[@bloodbros_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Sky Smasher';year:'1990';snd:1;hi:false;zip:'skysmash';grid:286;company:'Nihon System';rom:[@skysmash_rom,nil];tipo:ARCADE or SHOT),
  (name:'Baraduke';year:'1985';snd:1;hi:false;zip:'baraduke';grid:287;company:'Namco';rom:[@baraduke_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Metro-Cross';year:'1985';snd:1;hi:false;zip:'metrocrs';grid:288;company:'Namco';rom:[@metrocross_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'The Return of Ishtar';year:'1986';snd:1;hi:false;zip:'roishtar';grid:289;company:'Namco';rom:[@roishtar_rom,nil];tipo:ARCADE or MAZE),
  (name:'Genpei ToumaDen';year:'1986';snd:1;hi:false;zip:'genpeitd';grid:290;company:'Namco';rom:[@genpeitd_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Wonder Momo';year:'1987';snd:1;hi:false;zip:'wndrmomo';grid:291;company:'Namco';rom:[@wndrmomo_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Altered Beast';year:'1988';snd:1;hi:false;zip:'altbeast';grid:292;company:'Sega';rom:[@altbeast_rom,nil];tipo:ARCADE or FIGHT),
  (name:'Golden Axe';year:'1989';snd:1;hi:false;zip:'goldnaxe';grid:293;company:'Sega';rom:[@goldnaxe_rom,nil];tipo:ARCADE or FIGHT),
  (name:'Dynamite Dux';year:'1988';snd:1;hi:false;zip:'ddux1';grid:294;company:'Sega';rom:[@ddux_rom,nil];tipo:ARCADE or FIGHT),
  (name:'E-Swat - Cyber Police';year:'1989';snd:1;hi:false;zip:'eswat';grid:295;company:'Sega';rom:[@eswat_rom,nil];tipo:ARCADE or RUN_GUN or FIGHT),
  (name:'Passing Shot';year:'1988';snd:1;hi:false;zip:'passsht';grid:296;company:'Sega';rom:[@passsht_rom,nil];tipo:ARCADE or SPORT),
  (name:'Aurail';year:'1990';snd:1;hi:false;zip:'aurail';grid:297;company:'Sega';rom:[@aurail_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Hellfire';year:'1989';snd:1;hi:false;zip:'hellfire';grid:298;company:'Toaplan';rom:[@hellfire_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Lock''n''Chase';year:'1981';snd:1;hi:false;zip:'lnc';grid:299;company:'Deco';rom:[@lnc_rom,nil];tipo:ARCADE or MAZE),
  (name:'Minky Monkey';year:'1982';snd:1;hi:false;zip:'mmonkey';grid:300;company:'Deco';rom:[@mmonkey_rom,nil];tipo:ARCADE or MAZE),
  (name:'Karate Champ';year:'1984';snd:1;hi:false;zip:'kchamp';grid:301;company:'Data East';rom:[@karatechamp_rom,nil];tipo:ARCADE or SPORT or FIGHT),
  (name:'Thundercade';year:'1987';snd:1;hi:false;zip:'tndrcade';grid:302;company:'Seta';rom:[@tndrcade_rom,nil];tipo:ARCADE or SHOT),
  (name:'Twin Eagle - Revenge Joe''s Brother';year:'1988';snd:1;hi:false;zip:'twineagl';grid:303;company:'Seta';rom:[@twineagl_rom,nil];tipo:ARCADE or SHOT),
  (name:'Thunder & Lightning';year:'1990';snd:1;hi:false;zip:'thunderl';grid:304;company:'Seta';rom:[@thunderl_rom,nil];tipo:ARCADE or MAZE),
  (name:'Ms Pac Man Twin';year:'1992';snd:1;hi:false;zip:'mspactwin';grid:305;company:'Susilu';rom:[@mspactwin_rom,nil];tipo:ARCADE or MAZE),
  (name:'Extermination';year:'1987';snd:1;hi:false;zip:'extrmatn';grid:306;company:'Taito';rom:[@extrmatn_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Atomic Robo-kid';year:'1988';snd:1;hi:false;zip:'robokid';grid:307;company:'UPL';rom:[@robokid_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Mr. Do''s Castle';year:'1983';snd:1;hi:false;zip:'docastle';grid:308;company:'Universal';rom:[@mrdocastle_rom,nil];tipo:ARCADE or MAZE),
  (name:'Do! Run Run';year:'1984';snd:1;hi:false;zip:'dorunrun';grid:309;company:'Universal';rom:[@dorunrun_rom,nil];tipo:ARCADE or MAZE),
  (name:'Mr. Do''s Wild Ride';year:'1984';snd:1;hi:false;zip:'dowild';grid:310;company:'Universal';rom:[@dowild_rom,nil];tipo:ARCADE or MAZE),
  (name:'Jumping Jack';year:'1984';snd:1;hi:false;zip:'jjack';grid:311;company:'Universal';rom:[@jjack_rom,nil];tipo:ARCADE),
  (name:'Kick Rider';year:'1984';snd:1;hi:false;zip:'kickridr';grid:312;company:'Universal';rom:[@kickridr_rom,nil];tipo:ARCADE or SPORT or DRIVE),
  (name:'Indoor Soccer';year:'1985';snd:1;hi:false;zip:'idsoccer';grid:313;company:'Universal';rom:[@idsoccer_rom,nil];tipo:ARCADE or SPORT),
  (name:'Crystal Castles';year:'1983';snd:1;hi:false;zip:'ccastles';grid:314;company:'Atari';rom:[@ccastles_rom,nil];tipo:ARCADE or MAZE),
  (name:'Flower';year:'1986';snd:1;hi:false;zip:'flower';grid:315;company:'Clarue';rom:[@flower_rom,nil];tipo:ARCADE or SHOT),
  (name:'SlySpy';year:'1989';snd:1;hi:false;zip:'slyspy';grid:316;company:'Data East';rom:[@slyspy_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Boulder Dash I-II';year:'1990';snd:1;hi:false;zip:'bouldash';grid:317;company:'Data East';rom:[@bouldash_rom,nil];tipo:ARCADE or MAZE),
  (name:'Super Dodge Ball';year:'1987';snd:1;hi:false;zip:'spdodgeb';grid:318;company:'Technos';rom:[@sdodgeball_rom,nil];tipo:ARCADE or SPORT),
  (name:'Senjyo';year:'1983';snd:1;hi:false;zip:'senjyo';grid:319;company:'Tehkan';rom:[@senjyo_rom,nil];tipo:ARCADE or SHOT),
  (name:'Baluba-louk no Densetsu';year:'1986';snd:1;hi:false;zip:'baluba';grid:320;company:'Able Corp, Ltd.';rom:[@baluba_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Joust';year:'1982';snd:1;hi:false;zip:'joust';grid:321;company:'Williams';rom:[@joust_rom,nil];tipo:ARCADE or MAZE),
  (name:'Robotron';year:'1982';snd:1;hi:false;zip:'robotron';grid:322;company:'Williams';rom:[@robotron_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Stargate';year:'1981';snd:1;hi:false;zip:'stargate';grid:323;company:'Williams';rom:[@stargate_rom,nil];tipo:ARCADE or SHOT),
  (name:'Tapper';year:'1983';snd:1;hi:false;zip:'tapper';grid:324;company:'Bally Midway';rom:[@tapper_rom,nil];tipo:ARCADE),
  (name:'Arkanoid';year:'1986';snd:1;hi:false;zip:'arkanoid';grid:325;company:'Taito';rom:[@arkanoid_rom,nil];tipo:ARCADE or MAZE),
  (name:'Side Arms - Hyper Dyne';year:'1986';snd:1;hi:false;zip:'sidearms';grid:326;company:'Capcom';rom:[@sidearms_rom,nil];tipo:ARCADE or RUN_GUN or SHOT),
  (name:'The Speed Rumbler';year:'1986';snd:1;hi:false;zip:'srumbler';grid:327;company:'Capcom';rom:[@speedr_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'China Gate';year:'1988';snd:1;hi:false;zip:'chinagat';grid:328;company:'Technos Japan';rom:[@chinagate_rom,nil];tipo:ARCADE or RUN_GUN or FIGHT),
  (name:'Mag Max';year:'1985';snd:1;hi:false;zip:'magmax';grid:329;company:'Nichibutsu';rom:[@magmax_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'S.R.D. Mission';year:'1986';snd:1;hi:false;zip:'srdmissn';grid:330;company:'Kyugo/Sega';rom:[@srdmission_rom,nil];tipo:ARCADE or SHOT),
  (name:'Airwolf';year:'1987';snd:1;hi:false;zip:'airwolf';grid:331;company:'Kyugo';rom:[@airwolf_rom,nil];tipo:ARCADE or SHOT),
  (name:'Ambush';year:'1983';snd:1;hi:false;zip:'ambush';grid:332;company:'Tecfri';rom:[@ambush_rom,nil];tipo:ARCADE or SHOT),
  (name:'Super Duck';year:'1992';snd:1;hi:false;zip:'supduck';grid:333;company:'Comad';rom:[@superduck_rom,nil];tipo:ARCADE or MAZE),
  (name:'Hang-On';year:'1985';snd:1;hi:false;zip:'hangon';grid:334;company:'Sega';rom:[@hangon_rom,@hangon_sprite_zoom,nil];tipo:ARCADE or SPORT),
  (name:'Enduro Racer';year:'1986';snd:1;hi:false;zip:'enduror';grid:335;company:'Sega';rom:[@enduror_rom,@hangon_sprite_zoom,nil];tipo:ARCADE or SPORT),
  (name:'Space Harrier';year:'1985';snd:1;hi:false;zip:'sharrier';grid:336;company:'Sega';rom:[@sharrier_rom,@hangon_sprite_zoom,nil];tipo:ARCADE or RUN_GUN),
  (name:'64th Street - A detective story';year:'1991';snd:1;hi:false;zip:'64street';grid:337;company:'Jaleco';rom:[@th64_rom,nil];tipo:ARCADE or FIGHT),
  (name:'Shadow Warriors';year:'1988';snd:1;hi:false;zip:'shadoww';grid:338;company:'Tecmo';rom:[@shadoww_rom,nil];tipo:ARCADE or FIGHT),
  (name:'Wild Fang/Tecmo Knight';year:'1989';snd:1;hi:false;zip:'wildfang';grid:339;company:'Tecmo';rom:[@wildfang_rom,nil];tipo:ARCADE or FIGHT),
  (name:'Raiden';year:'1990';snd:1;hi:false;zip:'raiden';grid:340;company:'Seibu Kaihatsu';rom:[@raiden_rom_main,nil];tipo:ARCADE or SHOT),
  (name:'Twins';year:'1993';snd:1;hi:false;zip:'twins';grid:341;company:'Ecogames';rom:[@twins_rom,@twins_nv,nil];tipo:ARCADE or MAZE),
  (name:'Twins (Electronic Devices)';year:'1994';snd:1;hi:false;zip:'twinsed1';grid:342;company:'Ecogames';rom:[@twinsed1_rom,@twins_nv,nil];tipo:ARCADE or MAZE),
  (name:'Hot Blocks - Tetrix II';year:'1993';snd:1;hi:false;zip:'hotblock';grid:343;company:'NIX?';rom:[@hotblock_rom,nil];tipo:ARCADE or MAZE),
  (name:'Missile Command';year:'1980';snd:1;hi:false;zip:'missile';grid:344;company:'Atari';rom:[@missilec_rom,nil];tipo:ARCADE or SHOT),
  (name:'Super Missile Attack';year:'1981';snd:1;hi:false;zip:'suprmatk';grid:345;company:'Atari';rom:[@suprmatk_rom,@missilec_prom,nil];tipo:ARCADE or SHOT),
  (name:'Super Zaxxon';year:'1982';snd:3;hi:false;zip:'szaxxon';grid:346;company:'Sega';rom:[@szaxxon_rom,nil];samples:[@zaxxon_samples,nil];tipo:ARCADE or SHOT),
  (name:'Future Spy';year:'1984';snd:3;hi:false;zip:'futspy';grid:347;company:'Sega';rom:[@futspy_rom,nil];samples:[@zaxxon_samples,nil];tipo:ARCADE or SHOT),
  (name:'Millipede';year:'1982';snd:1;hi:false;zip:'milliped';grid:348;company:'Atari';rom:[@milliped_rom,nil];tipo:ARCADE or SHOT),
  (name:'Gaplus';year:'1984';snd:3;hi:false;zip:'gaplus';grid:349;company:'Namco';rom:[@gaplus_cpu1,nil];samples:[@gaplus_samples,nil];tipo:ARCADE or SHOT),
  (name:'Super Xevious';year:'1984';snd:3;hi:false;zip:'sxevious';grid:350;company:'Namco';rom:[@sxevious_rom,nil];samples:[@xevious_samples,nil];tipo:ARCADE or SHOT),
  (name:'Grobda';year:'1984';snd:1;hi:false;zip:'grobda';grid:351;company:'Namco';rom:[@grobda_rom,nil];tipo:ARCADE or SHOT),
  (name:'Pac & Pal';year:'1983';snd:1;hi:false;zip:'pacnpal';grid:352;company:'Namco';rom:[@pacnpal_rom,nil];tipo:ARCADE or MAZE),
  (name:'Birdiy';year:'1983';snd:1;hi:false;zip:'birdiy';grid:353;company:'Mama Top';rom:[@birdiy_rom,nil];tipo:ARCADE or MAZE),
  (name:'Wily Tower';year:'1984';snd:1;hi:false;zip:'wilytowr';grid:354;company:'Irem';rom:[@wilytower_rom,nil];tipo:ARCADE or MAZE),
  (name:'Fighting Basketball';year:'1984';snd:1;hi:false;zip:'fghtbskt';grid:355;company:'Irem';rom:[@fightbasket_rom,nil];tipo:ARCADE or SPORT),
  (name:'Diverboy';year:'1992';snd:1;hi:false;zip:'diverboy';grid:356;company:'Gamart';rom:[@diverboy_rom,nil];tipo:ARCADE or MAZE),
  (name:'Mug Smashers';year:'1990';snd:1;hi:false;zip:'mugsmash';grid:357;company:'Electronic Devices Italy';rom:[@mugsmash_rom,nil];tipo:ARCADE or FIGHT),
  (name:'Steel Force';year:'1994';snd:1;hi:false;zip:'stlforce';grid:358;company:'Ecogames';rom:[@steelforce_rom,nil];tipo:ARCADE or MAZE or SHOT),
  (name:'Twin Brats';year:'1995';snd:1;hi:false;zip:'twinbrat';grid:359;company:'Ecogames';rom:[@twinbrats_rom,nil];tipo:ARCADE or MAZE),
  (name:'Mortal Race';year:'1995';snd:1;hi:false;zip:'mortalr';grid:360;company:'Ecogames';rom:[@mortalrace_rom,nil];tipo:ARCADE or DRIVE),
  (name:'Bank Panic';year:'1985';snd:1;hi:false;zip:'bankp';grid:361;company:'Sanritsu/Sega';rom:[@bankpanic_rom,nil];tipo:ARCADE or SHOT),
  (name:'Combat Hawk';year:'1987';snd:1;hi:false;zip:'combh';grid:362;company:'Sanritsu/Sega';rom:[@combathawk_rom,nil];tipo:ARCADE or SHOT),
  (name:'Ant Eater';year:'1982';snd:1;hi:false;zip:'anteater';grid:363;company:'Tago Electronics';rom:[@anteater_rom,nil];tipo:ARCADE or MAZE),
  (name:'Appoooh';year:'1984';snd:1;hi:false;zip:'appoooh';grid:364;company:'Sanritsu/Sega';rom:[@appoooh_rom,nil];tipo:ARCADE or SPORT),
  (name:'Robo Wres 2001';year:'1986';snd:1;hi:false;zip:'robowres';grid:365;company:'Sanritsu/Sega';rom:[@robowres_rom,nil];tipo:ARCADE or SPORT),
  (name:'Armored Car';year:'1981';snd:1;hi:false;zip:'armorcar';grid:366;company:'Stern Electronics';rom:[@armoredcar_rom,nil];tipo:ARCADE or MAZE),
  (name:'88 Games';year:'1988';snd:1;hi:false;zip:'88games';grid:367;company:'Konami';rom:[@hw88games_rom,nil];tipo:ARCADE or SPORT),
  (name:'Avengers';year:'1987';snd:1;hi:false;zip:'avengers';grid:368;company:'Capcom';rom:[@avengers_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'The End';year:'1980';snd:1;hi:false;zip:'theend';grid:369;company:'Konami';rom:[@theend_rom,nil];tipo:ARCADE or SHOT),
  (name:'Battle of Atlantis';year:'1981';snd:1;hi:false;zip:'atlantis';grid:370;company:'Comsoft';rom:[@atlantis_rom,nil];tipo:ARCADE or SHOT),
  (name:'Blue Hawk';year:'1993';snd:1;hi:false;zip:'bluehawk';grid:371;company:'Dooyong';rom:[@bluehawk_rom,nil];tipo:ARCADE or SHOT),
  (name:'The Last Day';year:'1990';snd:1;hi:false;zip:'lastday';grid:372;company:'Dooyong';rom:[@lastday_rom,nil];tipo:ARCADE or SHOT),
  (name:'Gulf Storm';year:'1991';snd:1;hi:false;zip:'gulfstrm';grid:373;company:'Dooyong';rom:[@gulfstorm_rom,nil];tipo:ARCADE or SHOT),
  (name:'Pollux';year:'1991';snd:1;hi:false;zip:'pollux';grid:374;company:'Dooyong';rom:[@pollux_rom,nil];tipo:ARCADE or SHOT),
  (name:'Flying Tiger';year:'1992';snd:1;hi:false;zip:'flytiger';grid:375;company:'Dooyong';rom:[@flytiger_rom,nil];tipo:ARCADE or SHOT),
  (name:'Sky Skipper';year:'1981';snd:1;hi:false;zip:'skyskipr';grid:376;company:'Nintendo';rom:[@skyskipper_rom,nil];tipo:ARCADE or SHOT),
  (name:'Blue Print';year:'1982';snd:1;hi:false;zip:'blueprnt';grid:377;company:'Zilec Electronics/Bally Midway';rom:[@blueprint_rom,nil];tipo:ARCADE or MAZE),
  (name:'Saturn';year:'1983';snd:1;hi:false;zip:'saturnzi';grid:378;company:'Zilec Electronics/Jaleco';rom:[@saturnzi_rom,nil];tipo:ARCADE or SHOT),
  (name:'Grasspin';year:'1983';snd:1;hi:false;zip:'grasspin';grid:379;company:'Zilec Electronics/Jaleco';rom:[@grasspin_rom,nil];tipo:ARCADE or MAZE),
  (name:'BurglarX';year:'1997';snd:1;hi:false;zip:'burglarx';grid:380;company:'Unico';rom:[@burglarx_rom,nil];tipo:ARCADE or MAZE),
  (name:'Zero Point';year:'1998';snd:1;hi:false;zip:'zeropnt';grid:381;company:'Unico';rom:[@zeropnt_rom,nil];tipo:ARCADE or SHOT),
  (name:'Calipso';year:'1982';snd:1;hi:false;zip:'calipso';grid:382;company:'Tago Electronics';rom:[@calipso_rom,nil];tipo:ARCADE or MAZE),
  (name:'Calorie Kun vs Moguranian';year:'1986';snd:1;hi:false;zip:'calorie';grid:383;company:'Sega';rom:[@caloriekun_rom,nil];tipo:ARCADE or MAZE),
  (name:'Gardia';year:'1986';snd:1;hi:false;zip:'gardia';grid:384;company:'Sega';rom:[@gardia_rom,nil];tipo:ARCADE or SHOT),
  (name:'Cavelon';year:'1983';snd:1;hi:false;zip:'cavelon';grid:385;company:'Jetsoft';rom:[@cavelon_rom,nil];tipo:ARCADE or MAZE),
  (name:'Come Back Toto';year:'1996';snd:1;hi:false;zip:'toto';grid:386;company:'SoftClub';rom:[@toto_rom,nil];tipo:ARCADE or MAZE),
  (name:'Hyper Pacman';year:'1995';snd:1;hi:false;zip:'hyperpac';grid:387;company:'SemiCom';rom:[@hyperpac_rom,nil];tipo:ARCADE or MAZE),
  (name:'KiKi KaiKai';year:'1986';snd:1;hi:false;zip:'kikikai';grid:388;company:'Taito';rom:[@kikikaikai_rom,nil];tipo:ARCADE or RUN_GUN OR MAZE),
  (name:'Kick and Run';year:'1986';snd:1;hi:false;zip:'kicknrun';grid:389;company:'Taito';rom:[@kickrun_rom,nil];tipo:ARCADE or SPORT),
  (name:'Lasso';year:'1982';snd:1;hi:false;zip:'lasso';grid:390;company:'SNK';rom:[@lasso_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Chameleon';year:'1983';snd:1;hi:false;zip:'chameleo';grid:391;company:'Jaleco';rom:[@chameleo_rom,nil];tipo:ARCADE or MAZE),
  (name:'Last Mission';year:'1986';snd:1;hi:false;zip:'lastmisn';grid:392;company:'Data East';rom:[@lastmisn_rom,nil];tipo:ARCADE or SHOT),
  (name:'Shackled';year:'1986';snd:1;hi:false;zip:'shackled';grid:393;company:'Data East';rom:[@shackled_rom,nil];tipo:ARCADE or MAZE),
  (name:'Gondomania';year:'1987';snd:1;hi:false;zip:'gondo';grid:394;company:'Data East';rom:[@gondo_rom,nil];tipo:ARCADE or SHOT),
  (name:'Garyo Retsuden';year:'1987';snd:1;hi:false;zip:'garyoret';grid:395;company:'Data East';rom:[@garyoret_rom,nil];tipo:ARCADE or SHOT),
  (name:'Captain Silver';year:'1987';snd:1;hi:false;zip:'csilver';grid:396;company:'Data East';rom:[@csilver_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Cobra-Command';year:'1988';snd:1;hi:false;zip:'cobracom';grid:397;company:'Data East';rom:[@cobracom_rom,nil];tipo:ARCADE or SHOT),
  (name:'The Real Ghostbusters';year:'1987';snd:1;hi:false;zip:'ghostb';grid:398;company:'Data East';rom:[@ghostb_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Psycho-Nics Oscar';year:'1987';snd:1;hi:false;zip:'oscar';grid:399;company:'Data East';rom:[@oscar_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Road Fighter';year:'1984';snd:1;hi:false;zip:'roadf';grid:400;company:'Konami';rom:[@roadf_rom,nil];tipo:ARCADE or DRIVE),
  (name:'Ponpoko';year:'1982';snd:1;hi:false;zip:'ponpoko';grid:401;company:'Sigma';rom:[@ponpoko_rom,@pacman_sound,nil];tipo:ARCADE or MAZE),
  (name:'Woodpecker';year:'1981';snd:1;hi:false;zip:'woodpeck';grid:402;company:'Amenip';rom:[@woodpeck_rom,nil];tipo:ARCADE or MAZE),
  (name:'Eyes';year:'1982';snd:1;hi:false;zip:'eyes';grid:403;company:'Techstar';rom:[@eyes_rom,@pacman_sound,nil];tipo:ARCADE or MAZE),
  (name:'Ali Baba and 40 Thieves';year:'1982';snd:1;hi:false;zip:'alibaba';grid:404;company:'Sega';rom:[@alibaba_rom,@pacman_sound,nil];tipo:ARCADE or MAZE),
  (name:'Piranha';year:'1981';snd:1;hi:false;zip:'piranha';grid:405;company:'GL';rom:[@piranha_rom,@pacman_sound,nil];tipo:ARCADE or MAZE),
  (name:'Final Star Force';year:'1992';snd:1;hi:false;zip:'fstarfrc';grid:406;company:'Tecmo';rom:[@finalstarforce_rom,nil];tipo:ARCADE or SHOT),
  (name:'Wyvern F-0';year:'1985';snd:1;hi:false;zip:'wyvernf0';grid:407;company:'Taito';rom:[@wyvernf0_rom,nil];tipo:ARCADE or SHOT),
  (name:'Riot City';year:'1991';snd:1;hi:false;zip:'riotcity';grid:408;company:'Sega/Westone';rom:[@riotcity_rom,nil];tipo:ARCADE or FIGHT),
  (name:'SDI - Strategic Defense Initiative';year:'1987';snd:1;hi:false;zip:'sdib';grid:409;company:'Sega';rom:[@sdi_rom,nil];tipo:ARCADE or SHOT),
  (name:'Cotton';year:'1991';snd:1;hi:false;zip:'cotton';grid:410;company:'Sega';rom:[@cotton_rom,nil];tipo:ARCADE or SHOT),
  (name:'Discs of Tron';year:'1983';snd:1;hi:false;zip:'dotron';grid:411;company:'Bally Midway';rom:[@dotron_rom,nil];tipo:ARCADE or SHOT),
  (name:'Tron';year:'1981';snd:1;hi:false;zip:'tron';grid:412;company:'Bally Midway';rom:[@tron_rom,nil];tipo:ARCADE or SHOT),
  (name:'Timber';year:'1984';snd:1;hi:false;zip:'timber';grid:413;company:'Bally Midway';rom:[@timber_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Satan''s Hollow';year:'1981';snd:1;hi:false;zip:'shollow';grid:414;company:'Bally Midway';rom:[@shollow_rom,nil];tipo:ARCADE or SHOT),
  (name:'Domino Man';year:'1982';snd:1;hi:false;zip:'domino';grid:415;company:'Bally Midway';rom:[@domino_rom,nil];tipo:ARCADE or MAZE),
  (name:'Wacko';year:'1982';snd:1;hi:false;zip:'wacko';grid:416;company:'Bally Midway';rom:[@wacko_rom,nil];tipo:ARCADE or MAZE),
  (name:'Nastar';year:'1988';snd:1;hi:false;zip:'nastar';grid:417;company:'Taito';rom:[@nastar_rom,nil];tipo:ARCADE or RUN_GUN or FIGHT),
  (name:'Master of Weapon';year:'1989';snd:1;hi:false;zip:'masterw';grid:418;company:'Taito';rom:[@masterw_rom,nil];tipo:ARCADE or SHOT),
  (name:'Bay Route';year:'1989';snd:1;hi:false;zip:'bayroute';grid:419;company:'Sunsoft/Sega';rom:[@bayroute_rom,nil];tipo:ARCADE or RUN_GUN),
  (name:'Sonic Boom';year:'1987';snd:1;hi:false;zip:'sonicbom';grid:420;company:'Sega';rom:[@sonicbom_rom,nil];tipo:ARCADE or SHOT),
  (name:'Time Scanner';year:'1987';snd:1;hi:false;zip:'timescan';grid:421;company:'Sega';rom:[@timescan_rom,nil];tipo:ARCADE or SHOT),
  (name:'Willow';year:'1989';snd:1;hi:false;zip:'willow';grid:422;company:'Capcom';rom:[@willow_rom1,nil];tipo:ARCADE or RUN_GUN),
  (name:'1941: Counter Attack';year:'1990';snd:1;hi:false;zip:'1941';grid:423;company:'Capcom';rom:[@ca1941_rom1,nil];tipo:ARCADE or SHOT),
  (name:'Nemo';year:'1990';snd:1;hi:false;zip:'nemo';grid:424;company:'Capcom';rom:[@nemo_rom1,nil];tipo:ARCADE or RUN_GUN),
  (name:'Tokio';year:'1986';snd:1;hi:false;zip:'tokio';grid:425;company:'Taito';rom:[@tokio_rom,nil];tipo:ARCADE or SHOT),
  (name:'Super Bobble Bobble';year:'1986';snd:1;hi:false;zip:'sboblbobl';grid:426;company:'';rom:[@sboblbobl_rom,nil];tipo:ARCADE or SHOT),
  (name:'Mars';year:'1981';snd:1;hi:false;zip:'mars';grid:427;company:'Artic';rom:[@mars_rom,nil];tipo:ARCADE or SHOT),
  (name:'Devil Fish';year:'1982';snd:1;hi:false;zip:'devilfsh';grid:428;company:'Artic';rom:[@devilfish_rom,nil];tipo:ARCADE or MAZE),
  (name:'Dr. Micro';year:'1983';snd:1;hi:false;zip:'drmicro';grid:429;company:'Sanritsu';rom:[@drmicro_rom,nil];tipo:ARCADE or MAZE),
  //*** Consoles
  (name:'NES';year:'198X';snd:1;hi:false;zip:'';grid:1000;company:'Nintendo';tipo:CONSOLE),
  (name:'ColecoVision';year:'1980';snd:1;hi:false;zip:'coleco';grid:1001;company:'Coleco';rom:[@coleco_bios,nil];tipo:CONSOLE),
  (name:'GameBoy';year:'198X';snd:1;hi:false;zip:'gameboy';grid:1002;company:'Nintendo';rom:[@gameboy_rom,nil];tipo:CONSOLE),
  (name:'GameBoy Color';year:'198X';snd:1;hi:false;zip:'gbcolor';grid:1002;company:'Nintendo';rom:[@gbcolor_rom,nil];tipo:CONSOLE),
  (name:'CHIP 8';year:'197X';snd:1;hi:false;zip:'';grid:1003;company:'-';tipo:CONSOLE),
  (name:'Master System';year:'1986';snd:1;hi:false;zip:'sms';grid:1004;company:'Sega';rom:[@segams_bios,@segams_bios_j,nil];tipo:CONSOLE),
  ...
  (name:'Super Cassette Vision';year:'1984';snd:1;hi:false;zip:'scv';grid:1007;company:'Epoch';rom:[@supercv_bios,nil];tipo:CONSOLE),
  ...
  (name:'PV-2000';year:'1983';snd:1;hi:false;zip:'pv2000';grid:1010;company:'Casio';rom:[@pv2000_bios,nil];tipo:CONSOLE),
  //G&W
  (name:'Donkey Kong Jr';year:'1983';snd:1;hi:false;zip:'gnw_dj101';grid:2000;company:'Nintendo';rom:[@gnw_dj101_rom,nil];tipo:GNW),
  (name:'Donkey Kong II';year:'1983';snd:1;hi:false;zip:'gnw_jr55';grid:2001;company:'Nintendo';rom:[@gnw_jr55_rom,nil];tipo:GNW),
  (name:'Mario Bros';year:'1983';snd:1;hi:false;zip:'gnw_mw56';grid:2002;company:'Nintendo';rom:[@gnw_mw56_rom,nil];tipo:GNW));
...
case numero of
  ...
  3003:principal1.CambiarMaquina(principal1.msx1_1);
  ...
  419:principal1.CambiarMaquina(principal1.bayroute1);
  420:principal1.CambiarMaquina(principal1.sonicboom1);
  421:principal1.CambiarMaquina(principal1.timescanner1);
  422:principal1.CambiarMaquina(principal1.willow1);
  423:principal1.CambiarMaquina(principal1.n1941);
  424:principal1.CambiarMaquina(principal1.nemo1);
  425:principal1.CambiarMaquina(principal1.tokio1);
  426:principal1.CambiarMaquina(principal1.SuperBobleBoble1);
  427:principal1.CambiarMaquina(principal1.Mars1);
  428:principal1.CambiarMaquina(principal1.devilfish1);
  429:principal1.CambiarMaquina(principal1.drmicro1);
...
principal1.msx1_1.Checked:=false;
//Arcade
...
principal1.bayroute1.Checked:=false;
principal1.sonicboom1.Checked:=false;
principal1.timescanner1.Checked:=false;
principal1.willow1.Checked:=false;
principal1.n1941.Checked:=false;
principal1.nemo1.Checked:=false;
principal1.tokio1.Checked:=false;
principal1.SuperBobleBoble1.Checked:=false;
principal1.mars1.Checked:=false;
principal1.devilfish1.Checked:=false;
principal1.drmicro1.Checked:=false;
//consolas
...
principal1.BitBtn10.Hint:=leng.hints[2];
case driver of
  0..6:begin
  ...
  3003:begin //MSX
          ...
          principal1.BitBtn10.enabled:=true;
          principal1.BitBtn10.Hint:=leng.hints[4];
          principal1.BitBtn9.visible:=true; //Load Snapshot
       end;
  ...
  1008:begin
          principal1.Panel2.visible:=true;
          principal1.BitBtn10.visible:=true; //Cartucho
          principal1.BitBtn10.Hint:=leng.hints[3];
       end;
...
case tmaquina of
  ...
  3003:llamadas_maquina.iniciar:=iniciar_msx1;
  //arcade
  ...
  14,47,48,49,143,144,145,363,366,369,370,382,385,427,428:llamadas_maquina.iniciar:=iniciar_galaxian;
  ...
  46,425,426:llamadas_maquina.iniciar:=iniciar_bublbobl;
  ...
  103,104,105,106,107,108,109,110,111,112,113,422,423,424:llamadas_maquina.iniciar:=iniciar_cps1;
  ...
  292,293,294,295,296,297,408,409,410,419,420,421:llamadas_maquina.iniciar:=iniciar_system16b;
  ...
  429:llamadas_maquina.iniciar:=iniciar_drmicro;
  //consolas
...
if sender=principal1.msx1_1 then begin
  tipo:=3003;
  principal1.msx1_1.Checked:=true;
end;
//Arcade
...
if sender=principal1.bayroute1 then begin
  tipo:=419;
  principal1.bayroute1.Checked:=true;
end;
if sender=principal1.sonicboom1 then begin
  tipo:=420;
  principal1.sonicboom1.Checked:=true;
end;
if sender=principal1.timescanner1 then begin
  tipo:=421;
  principal1.timescanner1.Checked:=true;
end;
if sender=principal1.willow1 then begin
  tipo:=422;
  principal1.willow1.Checked:=true;
end;
if sender=principal1.n1941 then begin
  tipo:=423;
  principal1.n1941.Checked:=true;
end;
if sender=principal1.nemo1 then begin
  tipo:=424;
  principal1.nemo1.Checked:=true;
end;
if sender=principal1.tokio1 then begin
  tipo:=425;
  principal1.tokio1.Checked:=true;
end;
if sender=principal1.SuperBobleBoble1 then begin
  tipo:=426;
  principal1.SuperBobleBoble1.Checked:=true;
end;
if sender=principal1.mars1 then begin
  tipo:=427;
  principal1.mars1.Checked:=true;
end;
if sender=principal1.devilfish1 then begin
  tipo:=428;
  principal1.devilfish1.Checked:=true;
end;
if sender=principal1.drmicro1 then begin
  tipo:=429;
  principal1.drmicro1.Checked:=true;
end;
//consolas
