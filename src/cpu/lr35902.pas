...
begin
  ...
  self.tframes:=(GB_CLOCK/154)/llamadas_maquina.fps_max;
  r.sp:=0;
  r.pc:=0;
  r.bc.w:=0;
  r.de.w:=0;
...
case instruccion of
  ...
  $ff:begin //rst $38
    ...
    else MessageDlg('Instruccion desconocida LR35902. oldPC= '+inttohex(oldpc,4)+' - PC= '+inttohex(r.pc,4)+' - '+inttohex(instruccion,2), mtInformation,[mbOk], 0);
end; //Del case
